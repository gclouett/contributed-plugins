...
<table mat-table [dataSource]="dataSource" class="mat-elevation-z8">
    ...
    <ng-container matColumnDef="number">
        <th mat-header-cell *matHeaderCellDef> {{ 'plugins.searchPlugin.planNumberTitle' | translate }} </th>
        <td mat-cell *matCellDef="let element"> {{element.number}} </td>
    </ng-container>

    <ng-container matColumnDef="description">
        <th mat-header-cell *matHeaderCellDef> {{ 'plugins.searchPlugin.descriptionTitle' | translate }} </th>
            ...
            <summary class="wb-toggle tgl-tab wb-init wb-toggle-inited" data-toggle="{&quot;parent&quot;: &quot;#resultTabs&quot;, &quot;group&quot;: &quot;.resultTabs-grp&quot;}" aria-hidden="true" id="wb-auto-4" role="tab" aria-selected="true" tabindex="0" aria-posinset="1" aria-setsize="6">Survey Plan (<span id="queryParcelTabCount">0</span>)</summary><div class="tgl-panel" aria-labelledby="wb-auto-4" aria-expanded="true" aria-hidden="false">
                <table id="queryPlanResultTable" class="table table-striped table-condensed table-simplify col-sm-12" title="List of parcel results from the attribute and map searches.">
                    <thead>
                        ...
                        <th style="width: 20%;" scope="col">{{ 'plugins.searchPlugin.planNumberTitle' | translate }}</th>
                        <th style="width: 20%;" scope="col">{{ 'plugins.searchPlugin.descriptionTitle' | translate }}</th>
                        <th style="width: 20%;" scope="col">{{ 'plugins.searchPlugin.surveyDateTitle' | translate }}</th>
                        <th style="width: 20%;" scope="col">{{ 'plugins.searchPlugin.planDetailTitle' | translate }}</th>
                        <th style="width: 20%;" scope="col">{{ 'plugins.searchPlugin.bedfTitle' | translate }}</th>
                        </tr>
                    </thead>
